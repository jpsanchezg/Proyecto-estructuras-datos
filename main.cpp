    ...
    do
    {
        ...
        for (int i = 0; i < tokens.size(); i++)
        {
            ...
            else if (tokens[i] == "listar_departamentos")
            {
                if (DiviLista.empty())
                {
                    cout << "La lista de Divipolas esta vacia primero cargala" << endl;
                }
                else
                {
                }
            ...
            else if (tokens[i] == "carga_SC")
            {
                ...
                {
                    fout.open("Datos-ICM-2019.csv", ios::in); // se lee el archivo .csv
                    getline(fout, linea);                     // se omite la primera linea del archivo que no contiene nada importante
                    while (getline(fout, linea))
            ...
            else if (tokens[i] == "esta_en_sistema")
            {
                ...
                {
                    cout << "1" << endl;
                    list::const_iterator it = DiviLista.begin();
                    while (it != DiviLista.end())
                    {
                        cout << it-> << endl;
                        ++it;
                    }
                    ...
                    {
                        cout << "2" << endl;
                        cout << "con en list" << itr->cod_mpio << "municipio a buscar" << codigoMunicipio << endl;
                        if (itr->cod_mpio == codigoMunicipio)
                        {
                            for (auto otr = SClista.begin(); otr != SClista.end(); otr++)
                            {
                                if (otr->nom_mpio == itr->nom_mpio)
                                {
                                    encontroSCMU = true;
                                }
                            }
            ...
            {
                cout << endl;
                cout << "carga_divipola DIVIPOLA_CentrosPoblados.csv         ... " << '\t' << "Carga en una estructura de datos en memoria el contenido del archivo identificado por nombre_archivo." << endl;
                ...
                cout << "carga_SC Datos-ICM-2019.csv                ... " << '\t' << "Carga en una o mas estructuras de datos en memoria el contenido del archivo identificado por nombre_archivo con la informaci�n b�sica para representar el sistema de ciudades." << endl;
            ...
            cout << "" << endl;
            cout << "" << endl;
            cout << "" << endl;carga_SC Datos-ICM-2019
            cout << "" << endl;
            cout << "" << endl;
            cout << "" << endl;
            cout << "" << endl;
